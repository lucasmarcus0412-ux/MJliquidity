...
const CATEGORY_ICONS: Record<string, { name: string; family: 'ionicons' | 'feather' }> = {
...
function getCategoryIcon(cat: string, size: number, color: string) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: c.background }]}>
      <View style={[styles.header, { paddingTop: insets.top + 12 + webTopInset }]}>
        <View>
          <Text style={[styles.headerTitle, { color: c.gold }]}>Free Analysis</Text>
          <Text style={[styles.headerSubtitle, { color: c.textMuted }]}>Public Market Insights</Text>
        </View>
        {isAdmin && (
          <Pressable
            onPress={() => {
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyText, { color: c.textMuted }]}>
              Free market analysis and key levels will appear here
            </Text>
          </View>
        }
      />
...
const styles = StyleSheet.create({
  ...
  categoryChip: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, borderWidth: 1 },
