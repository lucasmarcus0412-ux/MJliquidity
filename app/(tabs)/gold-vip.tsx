...
export default function GoldVipScreen() {
  const c = Colors.dark;
  ...
  const handleSendMessage = async () => {
    ...
    await addChatMessage({ username: displayName, text: inputText.trim(), isAdmin }, 'gold_vip');
    ...
    >
      ...
      <View style={styles.tabRow}>
        <Pressable
          ...
          style={[styles.tabBtn, activeTab === 'analysis' && { borderBottomColor: c.gold, borderBottomWidth: 2 }]}
        >
          <Text style={[styles.tabText, { color: activeTab === 'analysis' ? c.gold : c.textMuted }]}>Analysis</Text>
        </Pressable>
        <Pressable
          onPress={() => setActiveTab('chat')}
          style={[styles.tabBtn, activeTab === 'chat' && { borderBottomColor: c.gold, borderBottomWidth: 2 }]}
        >
          <Text style={[styles.tabText, { color: activeTab === 'chat' ? c.gold : c.textMuted }]}>Members Chat</Text>
        </Pressable>
      </View>
      ...
      {activeTab === 'analysis' ? (
        ...
        <>
          <FlatList
            ...
            keyExtractor={(item) => item.id}
            renderItem={({ item }) => (
              <View style={[styles.messageBubble, item.isAdmin && styles.adminMessage]}>
            ...
            ListEmptyComponent={
              <View style={styles.emptyState}>
                ...
                <Text style={[styles.emptyTitle, { color: c.textSecondary }]}>Gold VIP Chat</Text>
          ...
          <View style={styles.modalOverlay}>
            <View style={[styles.composeModal, { backgroundColor: c.surface }]}>
              <View style={styles.composeHeader}>
                ...
                <Text style={[styles.composeTitle, { color: c.text }]}>Gold VIP Analysis</Text>
...
const styles = StyleSheet.create({
  ...
  adminMessage: { backgroundColor: 'rgba(201, 168, 76, 0.08)', borderWidth: 1, borderColor: 'rgba(201, 168, 76, 0.15)' },
