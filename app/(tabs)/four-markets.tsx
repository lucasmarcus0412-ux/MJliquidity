...
export default function FourMarketsScreen() {
  const c = Colors.dark;
  ...
  const handlePost = async () => {
    ...
    await addAnalysisPost({ title: title.trim(), content: content.trim(), category: selectedMarket, channel: 'four_markets' }, 'four_markets');
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyState}>
                ...
                <Text style={[styles.emptyTitle, { color: c.textSecondary }]}>4 Markets Chat</Text>
